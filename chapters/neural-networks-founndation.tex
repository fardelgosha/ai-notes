...
\begin{figure}[tb]
    \centering
    \input{../figures/perceptron_geometry.tikz}
...
Regularization augments the original loss function with a penalty term that discourages large parameter values. Given a data-dependent loss function $L_{\mathrm{data}}(W)$, L2 regularization modifies the optimization problem as
\[
